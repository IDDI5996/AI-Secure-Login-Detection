    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div class="mt-8 p-4 bg-gradient-to-r from-primary-50 to-blue-50 border border-primary-100 rounded-lg">
                    <div class="flex items-center">
                        <svg class="h-5 w-5 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        <span class="ml-2 text-sm font-medium text-primary-700">
                            AI Security Active • Real-time monitoring enabled
                        </span>
                    </div>
                </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="space-y-6 text-left">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-white">AI Behavior Analysis</h4>
                                        <p class="text-white/80 text-sm mt-1">Real-time pattern recognition and anomaly detection</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-white">Multi-factor Verification</h4>
                                        <p class="text-white/80 text-sm mt-1">Multiple verification methods for suspicious activities</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-white/80 text-sm mt-1">Continuous monitoring with instant alerts</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-12">
                                <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                                    ...
                                    <div class="text-xs text-white/70 mt-1">Accuracy</div>
                                </div>
                                <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                                    <div class="text-2xl font-bold text-white">50ms</div>
                                    <div class="text-xs text-white/70 mt-1">Response Time</div>
                                </div>
                                <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                                    <div class="text-2xl font-bold text-white">24/7</div>
                                    <div class="text-xs text-white/70 mt-1">Protection</div>
                                </div>
                            </div>
                        </div>
                    </div>

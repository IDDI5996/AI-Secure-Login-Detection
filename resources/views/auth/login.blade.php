            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Sign in to access your course materials and resources
                    </p>
                </div>
                ...
                <!-- Portal Info Banner -->
                <div class="mt-8 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-100 rounded-lg">
                    <div class="flex items-center">
                        <svg class="h-5 w-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="ml-2 text-sm font-medium text-purple-700">
                            📚 Access your course materials securely
                        </span>
                    </div>
                </div>
        ...
        <div class="hidden lg:block relative w-0 flex-1">
            <div class="absolute inset-0 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800">
                ...
                <div class="absolute inset-0 overflow-hidden">
                    ...
                    <div class="absolute top-1/3 -left-20 w-96 h-96 bg-white/5 rounded-full blur-3xl"></div>
                    <div class="absolute bottom-20 right-1/3 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
                    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-2xl bg-white/5 rounded-full blur-3xl"></div>
                </div>

                <!-- Student Portal Illustration -->
                        ...
                        <div class="text-center">
                            ...
                            <div class="space-y-6 text-left">
                                <div class="flex items-start">
                                    <svg class="h-6 w-6 text-green-300 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <div>
                                        <h4 class="text-lg font-semibold text-white">Access Course Materials</h4>
                                        <p class="text-white/80 text-sm mt-1">Lecture notes, assignments, and study resources</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-white">Secure Login</h4>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-white">Real-time Updates</h4>
                                        <p class="text-white/80 text-sm mt-1">Get notified when new materials are available</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-12">
                                ...
                                <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                                    ...
                                    <div class="text-xs text-white/70 mt-1">Platform</div>
                                </div>
                            </div>
